 ...
 * 2015-08-25T09:25:39.408+02:00
 * Generated source version: 3.1.2
 * 
 */
@WebServiceClient(name = "EjbcaWSService", 
                  wsdlLocation = "file:/Users/cf/IdeaProjects/client-cert/src/main/java/net/felsing/client_cert/ejbca/ejbcaws.wsdl",
...
public class EjbcaWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/cf/IdeaProjects/client-cert/src/main/java/net/felsing/client_cert/ejbca/ejbcaws.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EjbcaWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/cf/IdeaProjects/client-cert/src/main/java/net/felsing/client_cert/ejbca/ejbcaws.wsdl");
        }
        WSDL_LOCATION = url;
    }
