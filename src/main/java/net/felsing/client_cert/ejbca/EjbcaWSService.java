 ...
 * 2015-12-27T19:07:25.646+01:00
 * Generated source version: 3.1.2
 * 
 */
@WebServiceClient(name = "EjbcaWSService", 
                  wsdlLocation = "file:/Users/cf/IdeaProjects/ejbca-new-ra/src/main/java/net/felsing/client_cert/ejbca/ejbcaws2.wsdl",
...
public class EjbcaWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/cf/IdeaProjects/ejbca-new-ra/src/main/java/net/felsing/client_cert/ejbca/ejbcaws2.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EjbcaWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/cf/IdeaProjects/ejbca-new-ra/src/main/java/net/felsing/client_cert/ejbca/ejbcaws2.wsdl");
        }
        WSDL_LOCATION = url;
    }
